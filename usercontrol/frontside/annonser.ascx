<%@ Control EnableViewState="false" Language="C#" AutoEventWireup="true" CodeFile="annonser.ascx.cs" Inherits="usercontrol_frontside_annonser" %>
<table style="font-size:small; width: 720px; " align="center">
    <tr>
        <td style="padding-top:10px" valign="top" runat="server" id="kolcontent">
            ...
            <tr style="height:30px; width:720px;">
 	        <td valign="middle" style="padding-bottom:15px;">
                 ...
                 <a id="previous" style="font-weight:bold; color: #00b000;" 
                    runat="server" >Forrige annonsen</a></td>
            </tr>
            <tr style="width:720px;">
 	        <td align="right" valign="middle" style="font-weight:bold;height:35px;">
 	             <asp:LinkButton ID="back" runat="server" ForeColor="#00b000" Text="Tilbake" PostBackUrl="Default.aspx"
                    /></td>
            </tr>
            </table>  
        </td>
