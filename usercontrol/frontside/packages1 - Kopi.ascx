...
<td> Bestill Pakkereise<br/>
 <asp:DropdownList ID="reisen" runat="server" AutoPostBack="True" Width="225px">
                               ...
                               <asp:ListItem>Reise til Beijing, Shanghai og den mystiske sørvest-Kina (10 dager)</asp:ListItem>
                               <asp:ListItem>Kinas gyldne tre-kanter (11 dager)</asp:ListItem>
                               <asp:ListItem>Reise til Keisebyer, Tibet og Shanghai (18 dager)</asp:ListItem>
                               <asp:ListItem>Deluxe cruise på Yangtze (11 dager)</asp:ListItem>
                               <asp:ListItem>Reise til Beijing, Guilin og Shanghai (9 dager)</asp:ListItem>
                               <asp:ListItem>En uke i Beijing (7 dager)</asp:ListItem>
                               <asp:ListItem>Den klassiske rundreisen til Kina (11 dager)</asp:ListItem>
